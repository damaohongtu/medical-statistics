...
df1 = df[["第1天与第3天单核细胞PD-L1差值（%）", "第1天与第3天血乳酸差值（mmol/L）"]]
df1 = df1.dropna()
X = df1["第1天与第3天单核细胞PD-L1差值（%）"].values.reshape(-1, 1)
y = df1["第1天与第3天血乳酸差值（mmol/L）"].values.reshape(-1, 1)
...
ax1.text(x=50, y=7, s='$r=0.532$', fontsize=20)
ax1.text(x=50, y=8, s='$p=0.092$', fontsize=20)
