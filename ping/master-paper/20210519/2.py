...
df1 = df[["第1天与第3天单核细胞PD-L1差值（%）.2", "第1天与第3天APACHEII评分差值"]]
df1 = df1.dropna()
X = df1["第1天与第3天单核细胞PD-L1差值（%）.2"].values.reshape(-1, 1)
y = df1["第1天与第3天APACHEII评分差值"].values.reshape(-1, 1)
...
ax1.text(x=50, y=12, s='$r=0.096$', fontsize=20)
ax1.text(x=50, y=10, s='$p=0.779$', fontsize=20)
