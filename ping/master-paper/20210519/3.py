...
df1 = df[["第1天与第3天单核细胞PD-L1差值（%）.3", "第1天与第3天SOFA评分差值"]]
df1 = df1.dropna()
X = df1["第1天与第3天单核细胞PD-L1差值（%）.3"].values.reshape(-1, 1)
y = df1["第1天与第3天SOFA评分差值"].values.reshape(-1, 1)
...
ax1.text(x=50, y=6, s='$r=0.102$', fontsize=20)
ax1.text(x=50, y=7, s='$p=0.766$', fontsize=20)
