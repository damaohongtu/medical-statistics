...
df1 = df[["第1天与第3天单核细胞PD-L1差值（%）.7", "第1天与第3天SOFA评分差值.1"]]
df1 = df1.dropna()
X = df1["第1天与第3天单核细胞PD-L1差值（%）.7"].values.reshape(-1, 1)
y = df1["第1天与第3天SOFA评分差值.1"].values.reshape(-1, 1)
plt.xticks(fontsize=20)
plt.yticks(fontsize=20)
plt.xlabel("第1天与第3天单核细胞PD-L1差值(%)", fontsize=20)
plt.ylabel("第1天与第3天SOFA评分差值", fontsize=20)
...
ax1.text(x=8, y=2.6, s='$r=-0.800$', fontsize=20)
ax1.text(x=8, y=2.2, s='$p=0.200$', fontsize=20)
