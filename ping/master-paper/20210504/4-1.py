...
df1 = df[['对照组第一天单核细胞PD-L1百分比', '对照组第1天降钙素原浓度']]
print(df1['对照组第一天单核细胞PD-L1百分比'])
print(df1['对照组第1天降钙素原浓度'])
df1 = df1.dropna()
X = df1["对照组第一天单核细胞PD-L1百分比"].values.reshape(-1, 1)
y = df1["对照组第1天降钙素原浓度"].values.reshape(-1, 1)
...
ax1.text(x=10, y=4, s='$r=0.030$', fontsize=20)
ax1.text(x=10, y=5, s='$p=0.934$', fontsize=20)
