...
df1 = df[["第1天APACHE II评分", "第3天APACHE II评分"]]

ax1.boxplot([df1["第1天APACHE II评分"].dropna(), df1["第3天APACHE II评分"].dropna()], notch=False, sym='o', vert=True)
plt.xticks([x+1 for x in range(2)], ['第1天', '第3天'], fontsize=20)
plt.yticks(fontsize=20)
plt.ylabel("APACHE II评分", fontsize=16)
# 绘制比较线
x1, x2 = 1, 2
y, h, col = 30, 1, 'k'
ax1.set_ylim(0, 35)
