...
df1 = df[['对照组第3天单核细胞PD-L1.1', '对照组第3天血乳酸mmol/L.1']]
df1 = df1.dropna()
X = df1["对照组第3天单核细胞PD-L1.1"].values.reshape(-1, 1)
y = df1["对照组第3天血乳酸mmol/L.1"].values.reshape(-1, 1)
...
ax1.text(x=3.5, y=2.2, s='$r=-0.800$', fontsize=20)
ax1.text(x=3.5, y=2.25, s='$p=0.200$', fontsize=20)
