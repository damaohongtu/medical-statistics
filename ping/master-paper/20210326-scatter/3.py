...
df1 = df[['脓毒症组第1天单核细胞PD-L1.1', '脓毒症组第1天血乳酸.1']]
df1 = df1.dropna()
X = df1["脓毒症组第1天单核细胞PD-L1.1"].values.reshape(-1, 1)
y = df1["脓毒症组第1天血乳酸.1"].values.reshape(-1, 1)
...
ax1.text(x=60, y=6, s='$r=0.289$', fontsize=20)
ax1.text(x=60, y=7, s='$p=0.103$', fontsize=20)
# ax1.set_title("(a)脓毒症组", y=-0.4, fontsize=20)
ax1.set_title("脓毒症组", y=-0.2, fontsize=20)
