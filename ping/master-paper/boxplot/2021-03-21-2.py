...
df1 = df[["第1天乳酸", "第3天乳酸"]]
# df1 = df1.dropna()
ax1.boxplot([df1["第1天乳酸"].dropna(), df1["第3天乳酸"].dropna()], notch=False, sym='o', vert=True)
plt.xticks([x+1 for x in range(2)], ['第1天', '第3天'], fontsize=20)
plt.yticks(fontsize=20)
plt.ylabel("血乳酸mmol/L", fontsize=16)
# 绘制比较线
x1, x2 = 1, 2
y, h, col = 15, 1, 'k'
ax1.set_ylim(0, 20)
ax1.plot([x1, x1, x2, x2], [y, y+h, y+h, y], lw=1.5, c=col)
ax1.text((x1+x2)*.5, y+h+1, "$P=.352$", ha='center', va='bottom', color=col, fontsize=20)
