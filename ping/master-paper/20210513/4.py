...
df1 = df[["对照组第3天单核细胞PD-L1(%)", "对照组第3天血乳酸浓度（mmol/L）"]]
df1 = df1.dropna()
X = df1["对照组第3天单核细胞PD-L1(%)"].values.reshape(-1, 1)
y = df1["对照组第3天血乳酸浓度（mmol/L）"].values.reshape(-1, 1)
plt.xticks(fontsize=20)
plt.yticks(fontsize=20)
plt.xlabel("第3天单核细胞PD-L1(%)", fontsize=20)
plt.ylabel("第3天血乳酸浓度(mmol/L)", fontsize=20)
...
ax1.text(x=3.5, y=2.4, s='$r=-0.800$', fontsize=20)
ax1.text(x=3.5, y=2.2, s='$p=0.200$', fontsize=20)
