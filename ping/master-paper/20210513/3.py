...
df1 = df[["第1天单核细胞PD-L1表达水平.3", "SOFA评分.1"]]
df1 = df1.dropna()
X = df1["第1天单核细胞PD-L1表达水平.3"].values.reshape(-1, 1)
y = df1["SOFA评分.1"].values.reshape(-1, 1)
...
ax1.text(x=10, y=6, s='$r=0.359$', fontsize=20)
ax1.text(x=10, y=8, s='$p=0.252$', fontsize=20)
