...
df1 = df[["第1天单核细胞PD-L1表达水平.2", "APACHEII评分.1"]]
df1 = df1.dropna()
X = df1["第1天单核细胞PD-L1表达水平.2"].values.reshape(-1, 1)
y = df1["APACHEII评分.1"].values.reshape(-1, 1)
plt.xticks(fontsize=20)
plt.yticks(fontsize=20)
plt.xlabel("单核细胞PD-L1(%)", fontsize=20)
plt.ylabel("APACHEII评分", fontsize=20)
...
ax1.text(x=10, y=25, s='$r=0.133$', fontsize=20)
ax1.text(x=10, y=30, s='$p=0.681$', fontsize=20)
