...
df1 = df[["第1天单核细胞PD-L1表达水平", "APACHEII评分"]]
df1 = df1.dropna()
X = df1["第1天单核细胞PD-L1表达水平"].values.reshape(-1, 1)
y = df1["APACHEII评分"].values.reshape(-1, 1)
...
ax1.text(x=60, y=30, s='$r=-0.118$', fontsize=20)
ax1.text(x=60, y=35, s='$p=0.352$', fontsize=20)
