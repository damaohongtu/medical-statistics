...
# 图3-22 血浆IL-10浓度比较：（a）病例组与对照组第1天血浆IL-10浓度比较；（b）脓毒症休克组与脓毒症组第1天血浆IL-10浓度比较
def set_ax(ax):
...
df1 = df[['脓毒症休克IL10第1天', '脓毒症组IL10第1天']]
# df1 = df1.dropna()
ax1.boxplot([df1["脓毒症休克IL10第1天"].dropna(), df1["脓毒症组IL10第1天"].dropna()], notch=False, sym='o', vert=True)
plt.xticks([x+1 for x in range(2)], ['脓毒症休克组', '脓毒症组'], fontsize=20)
plt.yticks(fontsize=20)
plt.ylabel("IL10(pg/ml)", fontsize=16)
# 绘制比较线
x1, x2 = 1, 2
y, h, col = 900, 20, 'k'
ax1.set_ylim(0, 1000)
